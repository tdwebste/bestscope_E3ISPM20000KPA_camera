...
namespace Nn
{
    ...
    public class NnCam : IDisposable
    {
        ...
        internal delegate void PNNCAM_DATA_CALLBACK_V3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr pCallbackCtx);
        [UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)]
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern SafeCamHandle Nncam_Open([MarshalAs(UnmanagedType.LPWStr)] string id);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_StartPullModeWithCallback(SafeCamHandle h, PNNCAM_EVENT_CALLBACK pEventCallback, IntPtr pCallbackCtx);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_StartPushModeV3(SafeCamHandle h, PNNCAM_DATA_CALLBACK_V3 pDataCallback, IntPtr pDataCallbackCtx, PNNCAM_EVENT_CALLBACK pEventCallback, IntPtr pEventCallbackCtx);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        */
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern uint Nncam_get_Resolution(SafeCamHandle h, uint nResolutionIndex, out int pWidth, out int pHeight);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        */
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_put_ProcessMode(SafeCamHandle h, ePROCESSMODE nProcessMode);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_get_ProcessMode(SafeCamHandle h, out ePROCESSMODE pnProcessMode);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_put_RealTime(SafeCamHandle h, int bEnable);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        ...
        */
        ...
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_FfcOnePush(SafeCamHandle h);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
        private static extern int Nncam_DfcOnePush(SafeCamHandle h);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_FfcExport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_FfcImport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_DfcExport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        [DllImport("nncam.dll", ExactSpelling = true, CallingConvention = CallingConvention.Cdecl)]
        private static extern int Nncam_DfcImport(SafeCamHandle h, [MarshalAs(UnmanagedType.LPWStr)] string filepath);
        ...
        private PNNCAM_DATA_CALLBACK_V3       _pDataCallbackV3;
        private PNNCAM_EVENT_CALLBACK         _pEventCallback;
        private PINNCAM_HISTOGRAM_CALLBACK    _pHistogramCallback;
        ...
        private static void DataCallbackV3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr pCallbackCtx)
        {
            ...
            if (gch != null)
            {
                NnCam pthis = gch.Target as NnCam;
                if (pthis != null)
        ...
        */
        ...
        public bool Pause(bool bPause)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_Pause(_handle, bPause ? 1 : 0) >= 0);
        }
        ...
        */        
        ...
        public bool get_Size(out int nWidth, out int nHeight)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Size(_handle, out nWidth, out nHeight) >= 0);
        }
        ...
        */
        ...
        public bool get_eSize(out uint nResolutionIndex)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_eSize(_handle, out nResolutionIndex) >= 0);
        }
        ...
        public bool get_Resolution(uint nResolutionIndex, out int pWidth, out int pHeight)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Resolution(_handle, nResolutionIndex, out pWidth, out pHeight) >= 0);
        }
        ...
        */
        ...
        public bool get_ProcessMode(out ePROCESSMODE pnProcessMode)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_ProcessMode(_handle, out pnProcessMode) >= 0);
        }
        ...
        public bool put_RealTime(bool bEnable)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_RealTime(_handle, bEnable ? 1 : 0) >= 0);
        }
        ...
        public bool get_RealTime(out bool bEnable)
        {
            ...
            int iEnable = 0;
            if (Nncam_get_RealTime(_handle, out iEnable) < 0)
                return false;
        ...
        public bool get_AutoExpoEnable(out bool bAutoExposure)
        {
            ...
            int iEnable = 0;
            if (Nncam_get_AutoExpoEnable(_handle, out iEnable) < 0)
                return false;
        ...
        public bool put_AutoExpoEnable(bool bAutoExposure)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_AutoExpoEnable(_handle, bAutoExposure ? 1 : 0) >= 0);
        }
        ...
        public bool get_AutoExpoTarget(out ushort Target)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_AutoExpoTarget(_handle, out Target) >= 0);
        }
        ...
        public bool get_ExpoTime(out uint Time)/* in microseconds */
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_ExpoTime(_handle, out Time) >= 0);
        }
        ...
        public bool get_ExpTimeRange(out uint nMin, out uint nMax, out uint nDef)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_ExpTimeRange(_handle, out nMin, out nMax, out nDef) >= 0);
        }
        ...
        public bool get_ExpoAGain(out ushort AGain)/* percent, such as 300 */
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_ExpoAGain(_handle, out AGain) >= 0);
        }
        ...
        public bool get_ExpoAGainRange(out ushort nMin, out ushort nMax, out ushort nDef)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_ExpoAGainRange(_handle, out nMin, out nMax, out nDef) >= 0);
        }
        ...
        public bool get_Hue(out int Hue)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Hue(_handle, out Hue) >= 0);
        }
        ...
        public bool get_Saturation(out int Saturation)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Saturation(_handle, out Saturation) >= 0);
        }
        ...
        public bool get_Brightness(out int Brightness)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Brightness(_handle, out Brightness) >= 0);
        }
        ...
        public bool get_Contrast(out int Contrast)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Contrast(_handle, out Contrast) >= 0);
        }
        ...
        public bool get_Gamma(out int Gamma)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_Gamma(_handle, out Gamma) >= 0);
        }
        ...
        public bool get_Chrome(out bool bChrome)    /* monochromatic mode */
        {
            ...
            int iEnable = 0;
            if (Nncam_get_Chrome(_handle, out iEnable) < 0)
                return false;
        ...
        public bool put_Chrome(bool bChrome)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_Chrome(_handle, bChrome ? 1 : 0) >= 0);
        }
        ...
        public bool get_VFlip(out bool bVFlip) /* vertical flip */
        {
            ...
            int iVFlip = 0;
            if (Nncam_get_VFlip(_handle, out iVFlip) < 0)
                return false;
        ...
        public bool put_VFlip(bool bVFlip)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_VFlip(_handle, bVFlip ? 1 : 0) >= 0);
        }
        ...
        public bool get_HFlip(out bool bHFlip)
        {
            ...
            int iHFlip = 0;
            if (Nncam_get_HFlip(_handle, out iHFlip) < 0)
                return false;
        ...
        public bool get_Negative(out bool bNegative)
        {
            ...
            int iNegative = 0;
            if (Nncam_get_Negative(_handle, out iNegative) < 0)
                return false;
        ...
        */
        ...
        public bool get_HZ(out int nHZ)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_HZ(_handle, out nHZ) >= 0);
        }
        ...
        public bool put_Mode(bool bSkip) /* skip or bin */
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_Mode(_handle, bSkip ? 1 : 0) >= 0);
        }
        ...
        public bool get_Mode(out bool bSkip)
        {
            ...
            int iSkip = 0;
            if (Nncam_get_Mode(_handle, out iSkip) < 0)
                return false;
        ...
        public bool get_TempTint(out int nTemp, out int nTint)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_TempTint(_handle, out nTemp, out nTint) >= 0);
        }
        ...
        public bool put_AWBAuxRect(int X, int Y, int Width, int Height)
        {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return (Nncam_put_AWBAuxRect(_handle, ref rc) >= 0);
        }
        ...
        public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height)
        {
            ...
            RECT rc = new RECT();
            if (Nncam_get_AWBAuxRect(_handle, out rc) < 0)
                return false;
        ...
        public bool put_AEAuxRect(int X, int Y, int Width, int Height)
        {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return (Nncam_put_AEAuxRect(_handle, ref rc) >= 0);
        }
        ...
        public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height)
        {
            ...
            RECT rc = new RECT();
            if (Nncam_get_AEAuxRect(_handle, out rc) < 0)
                return false;
        ...
        public bool put_ABBAuxRect(int X, int Y, int Width, int Height)
        {
            ...
            rc.top = Y;
            rc.bottom = Y + Height;
            return (Nncam_put_ABBAuxRect(_handle, ref rc) >= 0);
        }
        ...
        public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height)
        {
            ...
            RECT rc = new RECT();
            if (Nncam_get_ABBAuxRect(_handle, out rc) < 0)
                return false;
        ...
        public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_StillResolution(_handle, nResolutionIndex, out pWidth, out pHeight) >= 0);
        }
        ...
        public bool put_VignetEnable(bool bEnable)
        {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_put_VignetEnable(_handle, bEnable ? 1 : 0) >= 0);
        }
        ...
        public bool get_VignetEnable(out bool bEnable)
        {
            ...
            int iEanble = 0;
            if (Nncam_get_VignetEnable(_handle, out iEanble) < 0)
                return false;
        ...
        public bool get_VignetAmountInt(out int nAmount)
        {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Nncam_get_VignetAmountInt(_handle, out nAmount) >= 0);
        }
