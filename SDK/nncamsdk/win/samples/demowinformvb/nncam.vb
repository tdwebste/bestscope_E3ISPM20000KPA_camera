...
'    Versin: @VERM@.$WCREV$.$WCDATE=%Y.%m%d$
'
'    For Microsoft .NET Framework.
'
'    We use P/Invoke to call into the nncam.dll API, the VB.net class NnCam is a thin wrapper class to the native api of nncam.dll.
'    So the manual en.html and hans.html are also applicable for programming with nncam.vb.
...
#If Not (NETFX_CORE OrElse WINDOWS_UWP) Then
    Public Class SafeCamHandle
        ...
        Private Shared Sub Nncam_Close(h As IntPtr)
        End Sub
...
#End If
    ...
    Public Class NnCam
        ...
        Public Enum eEVENT As UInteger
            ...
            EVENT_IMAGE = &H4          ' live image arrived, use Nncam_PullImage to get this image
            EVENT_STILLIMAGE = &H5     ' snap (still) frame arrived, use Nncam_PullStillImage to get this frame
            ...
            EVENT_AFFEEDBACK = &H83    ' auto focus sensor board positon
            EVENT_AFPOSITION = &H84    ' auto focus information feedback
        ...
        Public Enum eOPTION As UInteger
            ...
            OPTION_RAW = &H4                ' raw data mode, read the sensor "raw" data. This can be set only BEFORE Nncam_StartXXX(). 0 = rgb, 1 = raw, default value: 0
...
#End If
        ...
        Friend Delegate Sub PNNCAM_DATA_CALLBACK_V3(pData As IntPtr, pInfo As IntPtr, bSnap As Boolean, pCallbackCtx As IntPtr)
        <UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)>
        Friend Delegate Sub PINNCAM_HISTOGRAM_CALLBACK(aHistY As IntPtr, aHistR As IntPtr, aHistG As IntPtr, aHistB As IntPtr, pCtx As IntPtr)
        <UnmanagedFunctionPointerAttribute(CallingConvention.StdCall)>
        Friend Delegate Sub PNNCAM_EVENT_CALLBACK(nEvent As eEVENT, pCtx As IntPtr)
        ...
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Version() As IntPtr
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall), Obsolete("Use Nncam_EnumV2")>
        Private Shared Function Nncam_Enum(ti As IntPtr) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_EnumV2(ti As IntPtr) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Open(<MarshalAs(UnmanagedType.LPWStr)> id As String) As SafeCamHandle
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_OpenByIndex(index As UInteger) As SafeCamHandle
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_StartPullModeWithWndMsg(h As SafeCamHandle, hWnd As IntPtr, nMsg As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_StartPullModeWithCallback(h As SafeCamHandle, pEventCallback As PNNCAM_EVENT_CALLBACK, pCallbackCtx As IntPtr) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullImage(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullStillImage(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullImageWithRowPitch(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullStillImageWithRowPitch(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullImageV2(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, ByRef pInfo As FrameInfoV2) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullStillImageV2(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, ByRef pInfo As FrameInfoV2) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullImageWithRowPitchV2(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pInfo As FrameInfoV2) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_PullStillImageWithRowPitchV2(h As SafeCamHandle, pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pInfo As FrameInfoV2) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_StartPushModeV3(h As SafeCamHandle, pDataCallback As PNNCAM_DATA_CALLBACK_V3, pDataCallbackCtx As IntPtr, pEventCallback As PNNCAM_EVENT_CALLBACK, pEventCallbackCtx As IntPtr) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Stop(h As SafeCamHandle) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Pause(h As SafeCamHandle, bPause As Integer) As Integer
        End Function

        ' for still image snap
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Snap(h As SafeCamHandle, nResolutionIndex As UInteger) As Integer
        End Function
        ' multiple still image snap
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_SnapN(h As SafeCamHandle, nResolutionIndex As UInteger, nNumber As UInteger) As Integer
        End Function
        ...
        '
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Trigger(h As SafeCamHandle, nNumber As UShort) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Size(h As SafeCamHandle, nWidth As Integer, nHeight As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Size(h As SafeCamHandle, ByRef nWidth As Integer, ByRef nHeight As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_eSize(h As SafeCamHandle, nResolutionIndex As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_eSize(h As SafeCamHandle, ByRef nResolutionIndex As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ResolutionNumber(h As SafeCamHandle) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Resolution(h As SafeCamHandle, nResolutionIndex As UInteger, ByRef pWidth As Integer, ByRef pHeight As Integer) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ResolutionRatio(h As SafeCamHandle, nResolutionIndex As UInteger, ByRef pNumerator As Integer, ByRef pDenominator As Integer) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Field(h As SafeCamHandle) As UInteger
        End Function
        ...
        '   MAKEFOURCC('Y', 'Y', 'Y', 'Y')
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_RawFormat(h As SafeCamHandle, ByRef nFourCC As UInteger, ByRef bitdepth As UInteger) As UInteger
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_ProcessMode(h As SafeCamHandle, nProcessMode As ePROCESSMODE) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ProcessMode(h As SafeCamHandle, ByRef pnProcessMode As ePROCESSMODE) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_RealTime(h As SafeCamHandle, bEnable As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_RealTime(h As SafeCamHandle, ByRef bEnable As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_Flush(h As SafeCamHandle) As Integer
        End Function

        ' sensor Temperature
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Temperature(h As SafeCamHandle, ByRef pTemperature As Short) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Temperature(h As SafeCamHandle, nTemperature As Short) As Integer
        End Function

        ' ROI
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Roi(h As SafeCamHandle, ByRef xOffsett As UInteger, ByRef yOffsett As UInteger, ByRef xWidtht As UInteger, ByRef yHeightt As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Roi(h As SafeCamHandle, pxOffset As UInteger, pyOffset As UInteger, pxWidth As UInteger, pyHeight As UInteger) As Integer
        End Function
        ...
        '
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_AutoExpoEnable(h As SafeCamHandle, ByRef bAutoExposure As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_AutoExpoEnable(h As SafeCamHandle, bAutoExposure As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_AutoExpoTarget(h As SafeCamHandle, ByRef Target As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_AutoExpoTarget(h As SafeCamHandle, Target As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_MaxAutoExpoTimeAGain(h As SafeCamHandle, maxTime As UInteger, maxAGain As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_MaxAutoExpoTimeAGain(h As SafeCamHandle, ByRef maxTime As UInteger, ByRef maxAGain As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_MinAutoExpoTimeAGain(h As SafeCamHandle, minTime As UInteger, minAGain As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_MinAutoExpoTimeAGain(h As SafeCamHandle, ByRef minTime As UInteger, ByRef minAGain As UShort) As Integer
        End Function
        
        ' in microseconds
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ExpoTime(h As SafeCamHandle, ByRef Time As UInteger) As Integer
        End Function

        ' inmicroseconds
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_ExpoTime(h As SafeCamHandle, Time As UInteger) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ExpTimeRange(h As SafeCamHandle, ByRef nMin As UInteger, ByRef nMax As UInteger, ByRef nDef As UInteger) As Integer
        End Function

        ' percent, such as 300 
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ExpoAGain(h As SafeCamHandle, ByRef AGain As UShort) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_ExpoAGain(h As SafeCamHandle, AGain As UShort) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ExpoAGainRange(h As SafeCamHandle, ByRef nMin As UShort, ByRef nMax As UShort, ByRef nDef As UShort) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_LevelRange(h As SafeCamHandle, <[In]> aLow As UShort(), <[In]> aHigh As UShort()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_LevelRange(h As SafeCamHandle, <Out> aLow As UShort(), <Out> aHigh As UShort()) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Hue(h As SafeCamHandle, Hue As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Hue(h As SafeCamHandle, ByRef Hue As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Saturation(h As SafeCamHandle, Saturation As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Saturation(h As SafeCamHandle, ByRef Saturation As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Brightness(h As SafeCamHandle, Brightness As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Brightness(h As SafeCamHandle, ByRef Brightness As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Contrast(h As SafeCamHandle, ByRef Contrast As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Contrast(h As SafeCamHandle, Contrast As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Gamma(h As SafeCamHandle, ByRef Gamma As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Gamma(h As SafeCamHandle, Gamma As Integer) As Integer
        End Function

        ' monochromatic mode
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Chrome(h As SafeCamHandle, ByRef bChrome As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Chrome(h As SafeCamHandle, bChrome As Integer) As Integer
        End Function

        ' vertical flip
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_VFlip(h As SafeCamHandle, ByRef bVFlip As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_VFlip(h As SafeCamHandle, bVFlip As Integer) As Integer
        End Function

        ' horizontal flip
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_HFlip(h As SafeCamHandle, ByRef bHFlip As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_HFlip(h As SafeCamHandle, bHFlip As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Negative(h As SafeCamHandle, ByRef bNegative As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Negative(h As SafeCamHandle, bNegative As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Speed(h As SafeCamHandle, nSpeed As UShort) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Speed(h As SafeCamHandle, ByRef pSpeed As UShort) As Integer
        End Function

        ' get the maximum speed, "Frame Speed Level", speed range = [0, max]
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_MaxSpeed(h As SafeCamHandle) As UInteger
        End Function

        ' get the max bit depth of this camera, such as 8, 10, 12, 14, 16
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_MaxBitDepth(h As SafeCamHandle) As UInteger
        End Function

        ' get the maximum fan speed, the fan speed range = [0, max], closed interval
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_FanMaxSpeed(h As SafeCamHandle) As UInteger
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_HZ(h As SafeCamHandle, nHZ As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_HZ(h As SafeCamHandle, ByRef nHZ As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Mode(h As SafeCamHandle, bSkip As Integer) As Integer
        End Function
        ' skip or bin 
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Mode(h As SafeCamHandle, ByRef bSkip As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_TempTint(h As SafeCamHandle, nTemp As Integer, nTint As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_TempTint(h As SafeCamHandle, ByRef nTemp As Integer, ByRef nTint As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_WhiteBalanceGain(h As SafeCamHandle, <[In]> aGain As Integer()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_WhiteBalanceGain(h As SafeCamHandle, <Out> aGain As Integer()) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_BlackBalance(h As SafeCamHandle, <[In]> aSub As UShort()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_BlackBalance(h As SafeCamHandle, <Out> aSub As UShort()) As Integer
        End Function
        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_AWBAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_AWBAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_AEAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_AEAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_ABBAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ABBAuxRect(h As SafeCamHandle, ByRef pAuxRect As RECT) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_MonoMode(h As SafeCamHandle) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_StillResolutionNumber(h As SafeCamHandle) As UInteger
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_StillResolution(h As SafeCamHandle, nResolutionIndex As UInteger, ByRef pWidth As Integer, ByRef pHeight As Integer) As Integer
        End Function
        ...
        '
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Revision(h As SafeCamHandle, ByRef pRevision As UShort) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_SerialNumber(h As SafeCamHandle, sn As IntPtr) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_FwVersion(h As SafeCamHandle, fwver As IntPtr) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_HwVersion(h As SafeCamHandle, hwver As IntPtr) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_FpgaVersion(h As SafeCamHandle, fpgaver As IntPtr) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_ProductionDate(h As SafeCamHandle, pdate As IntPtr) As Integer
        End Function
        ...
        ' 
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_PixelSize(h As SafeCamHandle, nResolutionIndex As UInteger, ByRef x As Single, ByRef y As Single) As Integer
        End Function
        ...
        '        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_VignetEnable(h As SafeCamHandle, bEnable As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_VignetEnable(h As SafeCamHandle, ByRef bEnable As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_VignetAmountInt(h As SafeCamHandle, nAmount As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_VignetAmountInt(h As SafeCamHandle, ByRef nAmount As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_VignetMidPointInt(h As SafeCamHandle, nMidPoint As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_VignetMidPointInt(h As SafeCamHandle, ByRef nMidPoint As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_AwbOnePush(h As SafeCamHandle, fnTTProc As IntPtr, pTTCtx As IntPtr) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_AwbInit(h As SafeCamHandle, fnWBProc As IntPtr, pWBCtx As IntPtr) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_LevelRangeAuto(h As SafeCamHandle) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_GetHistogram(h As SafeCamHandle, fnHistogramProc As PINNCAM_HISTOGRAM_CALLBACK, pHistogramCtx As IntPtr) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_AbbOnePush(h As SafeCamHandle, fnBBProc As IntPtr, pBBCtx As IntPtr) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_LEDState(h As SafeCamHandle, iLed As UShort, iState As UShort, iPeriod As UShort) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_write_EEPROM(h As SafeCamHandle, addr As UInteger, pBuffer As IntPtr, nBufferLen As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_read_EEPROM(h As SafeCamHandle, addr As UInteger, pBuffer As IntPtr, nBufferLen As UInteger) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_write_UART(h As SafeCamHandle, pBuffer As IntPtr, nBufferLen As UInteger) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_read_UART(h As SafeCamHandle, pBuffer As IntPtr, nBufferLen As UInteger) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Option(h As SafeCamHandle, iOption As eOPTION, iValue As Integer) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_Option(h As SafeCamHandle, iOption As eOPTION, ByRef iValue As Integer) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Linear(h As SafeCamHandle, v8 As Byte(), v16 As UShort()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_Curve(h As SafeCamHandle, v8 As Byte(), v16 As UShort()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_ColorMatrix(h As SafeCamHandle, v As Double()) As Integer
        End Function
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_put_InitWBGain(h As SafeCamHandle, v As UShort()) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_FrameRate(h As SafeCamHandle, ByRef nFrame As UInteger, ByRef nTime As UInteger, ByRef nTotalFrame As UInteger) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_FfcOnePush(h As SafeCamHandle) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_DfcOnePush(h As SafeCamHandle) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_FfcImport(h As SafeCamHandle, <MarshalAs(UnmanagedType.LPWStr)> filepath As String) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_FfcExport(h As SafeCamHandle, <MarshalAs(UnmanagedType.LPWStr)> filepath As String) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_DfcImport(h As SafeCamHandle, <MarshalAs(UnmanagedType.LPWStr)> filepath As String) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_DfcExport(h As SafeCamHandle, <MarshalAs(UnmanagedType.LPWStr)> filepath As String) As Integer
        End Function
        
        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_IoControl(h As SafeCamHandle, index As UInteger, eType As eIoControType, inVal As Integer, ByRef outVal As UInteger) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_get_AfParam(h As SafeCamHandle, ByRef pAfParam As AfParam) As Integer
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_calc_ClarityFactor(pImageData As IntPtr, bits As Integer, nImgWidth As UInteger, nImgHeight As UInteger) As Double
        End Function

        <DllImport("nncam.dll", ExactSpelling:=True, CallingConvention:=CallingConvention.StdCall)>
        Private Shared Function Nncam_deBayerV2(nBayer As UInteger, nW As Integer, nH As Integer, input As IntPtr, output As IntPtr, nBitDepth As Byte, nBitCount As Byte)
        End Function
        ...
        Private _pDataCallbackV3 As PNNCAM_DATA_CALLBACK_V3
        Private _pEventCallback As PNNCAM_EVENT_CALLBACK
        Private _pHistogramCallback As PINNCAM_HISTOGRAM_CALLBACK
...
#End If
        ...
        Private Shared Sub DataCallbackV3(pData As IntPtr, pInfo As IntPtr, bSnap As Boolean, pCallbackCtx As IntPtr)
            ...
            Dim pthis As NnCam = TryCast(gch.Target, NnCam)
...
#End If
        ...
        Public Shared Function [EnumV2]() As InstanceV2()
            ...
            Dim cnt As UInteger = Nncam_EnumV2(ti)
        ...
        Public Shared Function [Enum]() As Instance()
            Dim ti As IntPtr = Marshal.AllocHGlobal(512 * 16)
            Dim cnt As UInteger = Nncam_Enum(ti)
        ...
        Public Shared Function Open(id As String) As NnCam
            Dim tmphandle As SafeCamHandle = Nncam_Open(id)
        ...
        ' etc
        Public Shared Function OpenByIndex(index As UInteger) As NnCam
            Dim tmphandle As SafeCamHandle = Nncam_OpenByIndex(index)
            If tmphandle Is Nothing OrElse tmphandle.IsInvalid OrElse tmphandle.IsClosed Then
                Return Nothing
            End If
            Return New NnCam(tmphandle)
        ...
        Public ReadOnly Property Revision() As UShort
            Get
                ...
                If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                    Return rev
                End If
                Nncam_get_Revision(_handle, rev)
                return rev
            End Get
        End Property
        ...
        Public ReadOnly Property SerialNumber() As String
            Get
                ...
                If Nncam_get_SerialNumber(_handle, ptr) >= 0 Then
        ...
        Public ReadOnly Property FwVersion() As String
            Get
                ...
                If Nncam_get_FwVersion(_handle, ptr) >= 0 Then
                    str = ""
                Else
                    str = Marshal.PtrToStringAnsi(ptr)
                End If
        ...
        Public ReadOnly Property HwVersion() As String
            Get
                ...
                End If
                Dim ptr As IntPtr = Marshal.AllocHGlobal(32)
                If Nncam_get_HwVersion(_handle, ptr) >= 0 Then
                    str = ""
                Else
                    str = Marshal.PtrToStringAnsi(ptr)
                End If
        ...
        Public ReadOnly Property FpgaVersion() As String
            Get
                ...
                End If
                Dim ptr As IntPtr = Marshal.AllocHGlobal(32)
                If Nncam_get_FpgaVersion(_handle, ptr) >= 0 Then
                    str = ""
                Else
                    str = Marshal.PtrToStringAnsi(ptr)
                End If
        ...
        Public ReadOnly Property ProductionDate() As String
            Get
                ...
                End If
                Dim ptr As IntPtr = Marshal.AllocHGlobal(32)
                If Nncam_get_ProductionDate(_handle, ptr) >= 0 Then
                    str = ""
                Else
                    str = Marshal.PtrToStringAnsi(ptr)
                End If
        ...
        Public ReadOnly Property Field() As UInteger
            Get
                If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                    Return 0
                End If
                Return Nncam_get_Field(_handle)
            End Get
        End Property
...
#End If
        ...
        Public Function StartPullModeWithCallback(edelegate As DelegateEventCallback) As Boolean
            ...
            If edelegate Is Nothing Then
                Return (Nncam_StartPullModeWithCallback(_handle, Nothing, IntPtr.Zero) >= 0)
            Else
                _pEventCallback = New PNNCAM_EVENT_CALLBACK(AddressOf EventCallback)
                Return (Nncam_StartPullModeWithCallback(_handle, _pEventCallback, GCHandle.ToIntPtr(_gchandle)) >= 0)
            End If
        End Function
        ...
        Public Function PullImage(pImageData As IntPtr, bits As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Boolean
            ...
            Return (Nncam_PullImage(_handle, pImageData, bits, pnWidth, pnHeight) >= 0)
        End Function
        ...
        Public Function PullImageV2(pImageData As IntPtr, bits As Integer, ByRef pInfo As FrameInfoV2) As Boolean
            ...
            Return (Nncam_PullImageV2(_handle, pImageData, bits, pInfo) >= 0)
        End Function
        ...
        Public Function PullStillImage(pImageData As IntPtr, bits As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Boolean
            ...
            Return (Nncam_PullStillImage(_handle, pImageData, bits, pnWidth, pnHeight) >= 0)
        End Function
        ...
        Public Function PullStillImageV2(pImageData As IntPtr, bits As Integer, ByRef pInfo As FrameInfoV2) As Boolean
            ...
            Return (Nncam_PullStillImageV2(_handle, pImageData, bits, pInfo) >= 0)
        End Function
        ...
        Public Function PullImageWithRowPitch(pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Boolean
            ...
            Return (Nncam_PullImageWithRowPitch(_handle, pImageData, bits, rowPitch, pnWidth, pnHeight) >= 0)
        End Function
        ...
        Public Function PullImageWithRowPitchV2(pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pInfo As FrameInfoV2) As Boolean
            ...
            Return (Nncam_PullImageWithRowPitchV2(_handle, pImageData, bits, rowPitch, pInfo) >= 0)
        End Function
        ...
        Public Function PullStillImageWithRowPitch(pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pnWidth As UInteger, ByRef pnHeight As UInteger) As Boolean
            ...
            Return (Nncam_PullStillImageWithRowPitch(_handle, pImageData, bits, rowPitch, pnWidth, pnHeight) >= 0)
        End Function
        ...
        Public Function PullStillImageWithRowPitchV2(pImageData As IntPtr, bits As Integer, rowPitch As Integer, ByRef pInfo As FrameInfoV2) As Boolean
            ...
            Return (Nncam_PullStillImageWithRowPitchV2(_handle, pImageData, bits, rowPitch, pInfo) >= 0)
        End Function
        ...
        Public Function StartPushModeV3(ddelegate As DelegateDataCallbackV3, edelegate As DelegateEventCallback) As Boolean
            ...
            _dEventCallback = edelegate
            _pDataCallbackV3 = New PNNCAM_DATA_CALLBACK_V3(AddressOf DataCallbackV3)
            _pEventCallback = New PNNCAM_EVENT_CALLBACK(AddressOf EventCallback)
        ...
        Public Function Pause(bPause As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_Pause(_handle, If(bPause, 1, 0)) >= 0)
        End Function
        ...
        Public Function Snap(nResolutionIndex As UInteger) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_Snap(_handle, nResolutionIndex) >= 0)
        End Function
        ...
        Public Function Trigger(nNumber As UShort) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_Trigger(_handle, nNumber) >= 0)
        End Function
        ...
        Public Function put_Size(nWidth As Integer, nHeight As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Size(_handle, nWidth, nHeight) >= 0)
        End Function
        ...
        Public Function get_Size(ByRef nWidth As Integer, ByRef nHeight As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Size(_handle, nWidth, nHeight) >= 0)
        End Function
        ...
        Public Function put_eSize(nResolutionIndex As UInteger) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_eSize(_handle, nResolutionIndex) >= 0)
        End Function
        ...
        Public Function get_eSize(ByRef nResolutionIndex As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_eSize(_handle, nResolutionIndex) >= 0)
        End Function
        ...
        Public Function get_Resolution(nResolutionIndex As UInteger, ByRef pWidth As Integer, ByRef pHeight As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Resolution(_handle, nResolutionIndex, pWidth, pHeight) >= 0)
        End Function
        ...
        Public Function get_PixelSize(nResolutionIndex As UInteger, ByRef x As Single, ByRef y As Single) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_PixelSize(_handle, nResolutionIndex, x, y) >= 0)
        End Function
        ...
        Public Function get_ResolutionRatio(nResolutionIndex As UInteger, ByRef pNumerator As Integer, ByRef pDenominator As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ResolutionRatio(_handle, nResolutionIndex, pNumerator, pDenominator) >= 0)
        End Function
        ...
        Public Function get_RawFormat(ByRef nFourCC As UInteger, ByRef bitdepth As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_RawFormat(_handle, nFourCC, bitdepth) >= 0)
        End Function
        ...
        Public Function put_ProcessMode(nProcessMode As ePROCESSMODE) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_ProcessMode(_handle, nProcessMode) >= 0)
        End Function
        ...
        Public Function get_ProcessMode(ByRef pnProcessMode As ePROCESSMODE) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ProcessMode(_handle, pnProcessMode) >= 0)
        End Function
        ...
        Public Function put_RealTime(bEnable As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_RealTime(_handle, If(bEnable, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_RealTime(ByRef bEnable As Boolean) As Boolean
            ...
            If Nncam_get_RealTime(_handle, iEnable) < 0 Then
                Return False
            End If
        ...
        Public Function get_AutoExpoEnable(ByRef bAutoExposure As Boolean) As Boolean
            ...
            Dim iEnable As Integer = 0
            If Nncam_get_AutoExpoEnable(_handle, iEnable) < 0 Then
                Return False
            End If
        ...
        Public Function put_AutoExpoEnable(bAutoExposure As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_AutoExpoEnable(_handle, If(bAutoExposure, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_AutoExpoTarget(ByRef Target As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_AutoExpoTarget(_handle, Target) >= 0)
        End Function
        ...
        Public Function put_AutoExpoTarget(Target As UShort) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_AutoExpoTarget(_handle, Target) >= 0)
        End Function
        ...
        Public Function put_MaxAutoExpoTimeAGain(maxTime As UInteger, maxAGain As UShort) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_MaxAutoExpoTimeAGain(_handle, maxTime, maxAGain) >= 0)
        End Function
        ...
        Public Function get_MinAutoExpoTimeAGain(ByRef minTime As UInteger, ByRef minAGain As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_MinAutoExpoTimeAGain(_handle, minTime, minAGain) >= 0)
        End Function
        ...
        Public Function get_MaxAutoExpoTimeAGain(ByRef maxTime As UInteger, ByRef maxAGain As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_MaxAutoExpoTimeAGain(_handle, maxTime, maxAGain) >= 0)
        End Function
        ...
        Public Function get_ExpoTime(ByRef Time As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ExpoTime(_handle, Time) >= 0)
        End Function
        ...
        Public Function put_ExpoTime(Time As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_ExpoTime(_handle, Time) >= 0)
        End Function
        ...
        Public Function get_ExpTimeRange(ByRef nMin As UInteger, ByRef nMax As UInteger, ByRef nDef As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ExpTimeRange(_handle, nMin, nMax, nDef) >= 0)
        End Function
        ...
        Public Function get_ExpoAGain(ByRef AGain As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ExpoAGain(_handle, AGain) >= 0)
        End Function
        ...
        Public Function put_ExpoAGain(AGain As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_ExpoAGain(_handle, AGain) >= 0)
        End Function
        ...
        Public Function get_ExpoAGainRange(ByRef nMin As UShort, ByRef nMax As UShort, ByRef nDef As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_ExpoAGainRange(_handle, nMin, nMax, nDef) >= 0)
        End Function
        ...
        Public Function put_LevelRange(aLow As UShort(), aHigh As UShort()) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_LevelRange(_handle, aLow, aHigh) >= 0)
        End Function
        ...
        Public Function get_LevelRange(aLow As UShort(), aHigh As UShort()) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_LevelRange(_handle, aLow, aHigh) >= 0)
        End Function
        ...
        Public Function put_Hue(Hue As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Hue(_handle, Hue) >= 0)
        End Function
        ...
        Public Function get_Hue(ByRef Hue As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Hue(_handle, Hue) >= 0)
        End Function
        ...
        Public Function put_Saturation(Saturation As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Saturation(_handle, Saturation) >= 0)
        End Function
        ...
        Public Function get_Saturation(ByRef Saturation As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Saturation(_handle, Saturation) >= 0)
        End Function
        ...
        Public Function put_Brightness(Brightness As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Brightness(_handle, Brightness) >= 0)
        End Function
        ...
        Public Function get_Brightness(ByRef Brightness As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Brightness(_handle, Brightness) >= 0)
        End Function
        ...
        Public Function get_Contrast(ByRef Contrast As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Contrast(_handle, Contrast) >= 0)
        End Function
        ...
        Public Function put_Contrast(Contrast As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Contrast(_handle, Contrast) >= 0)
        End Function
        ...
        Public Function get_Gamma(ByRef Gamma As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Gamma(_handle, Gamma) >= 0)
        End Function
        ...
        Public Function put_Gamma(Gamma As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Gamma(_handle, Gamma) >= 0)
        End Function
        ...
        Public Function get_Chrome(ByRef bChrome As Boolean) As Boolean
            ...
            Dim iEnable As Integer = 0
            If Nncam_get_Chrome(_handle, iEnable) < 0 Then
                Return False
            End If
        ...
        Public Function put_Chrome(bChrome As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Chrome(_handle, If(bChrome, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_VFlip(ByRef bVFlip As Boolean) As Boolean
            ...
            If Nncam_get_VFlip(_handle, iVFlip) < 0 Then
                Return False
            End If
        ...
        Public Function put_VFlip(bVFlip As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_VFlip(_handle, If(bVFlip, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_HFlip(ByRef bHFlip As Boolean) As Boolean
            ...
            If Nncam_get_HFlip(_handle, iHFlip) < 0 Then
                Return False
            End If
        ...
        Public Function put_HFlip(bHFlip As Boolean) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_HFlip(_handle, If(bHFlip, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_Negative(ByRef bNegative As Boolean) As Boolean
            ...
            If Nncam_get_Negative(_handle, iNegative) < 0 Then
                Return False
            End If
        ...
        Public Function put_Negative(bNegative As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Negative(_handle, If(bNegative, 1, 0)) >= 0)
        End Function
        ...
        Public Function put_Speed(nSpeed As UShort) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Speed(_handle, nSpeed) >= 0)
        End Function
        ...
        Public Function get_Speed(ByRef pSpeed As UShort) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Speed(_handle, pSpeed) >= 0)
        End Function
        ...
        Public Function put_HZ(nHZ As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_HZ(_handle, nHZ) >= 0)
        End Function
        ...
        Public Function get_HZ(ByRef nHZ As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_HZ(_handle, nHZ) >= 0)
        End Function
        ...
        Public Function put_Mode(bSkip As Boolean) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Mode(_handle, If(bSkip, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_Mode(ByRef bSkip As Boolean) As Boolean
            ...
            If Nncam_get_Mode(_handle, iSkip) < 0 Then
                Return False
            End If
        ...
        Public Function put_TempTint(nTemp As Integer, nTint As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_TempTint(_handle, nTemp, nTint) >= 0)
        End Function
        ...
        Public Function get_TempTint(ByRef nTemp As Integer, ByRef nTint As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_TempTint(_handle, nTemp, nTint) >= 0)
        End Function
        ...
        Public Function put_WhiteBalanceGain(aGain As Integer()) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_WhiteBalanceGain(_handle, aGain) >= 0)
        End Function
        ...
        Public Function put_AWBAuxRect(X As Integer, Y As Integer, Width As Integer, Height As Integer) As Boolean
            ...
            rc.top = Y
            rc.bottom = Y + Height
            Return (Nncam_put_AWBAuxRect(_handle, rc) >= 0)
        End Function
        ...
        Public Function get_AWBAuxRect(ByRef X As Integer, ByRef Y As Integer, ByRef Width As Integer, ByRef Height As Integer) As Boolean
            ...
            Dim rc As New RECT()
            If Nncam_get_AWBAuxRect(_handle, rc) < 0 Then
                Return False
            End If
        ...
        Public Function put_BlackBalance(aSub As UShort()) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_BlackBalance(_handle, aSub) >= 0)
        End Function
        ...
        Public Function put_ABBAuxRect(X As Integer, Y As Integer, Width As Integer, Height As Integer) As Boolean
            ...
            rc.top = Y
            rc.bottom = Y + Height
            Return (Nncam_put_ABBAuxRect(_handle, rc) >= 0)
        End Function
        ...
        Public Function get_ABBAuxRect(ByRef X As Integer, ByRef Y As Integer, ByRef Width As Integer, ByRef Height As Integer) As Boolean
            ...
            Dim rc As New RECT()
            If Nncam_get_ABBAuxRect(_handle, rc) < 0 Then
                Return False
            End If
        ...
        Public Function put_AEAuxRect(X As Integer, Y As Integer, Width As Integer, Height As Integer) As Boolean
            ...
            rc.top = Y
            rc.bottom = Y + Height
            Return (Nncam_put_AEAuxRect(_handle, rc) >= 0)
        End Function
        ...
        Public Function get_AEAuxRect(ByRef X As Integer, ByRef Y As Integer, ByRef Width As Integer, ByRef Height As Integer) As Boolean
            ...
            Dim rc As New RECT()
            If Nncam_get_AEAuxRect(_handle, rc) < 0 Then
                Return False
            End If
        ...
        Public Function get_StillResolution(nResolutionIndex As UInteger, ByRef pWidth As Integer, ByRef pHeight As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_StillResolution(_handle, nResolutionIndex, pWidth, pHeight) >= 0)
        End Function
        ...
        Public Function put_VignetEnable(bEnable As Boolean) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_VignetEnable(_handle, If(bEnable, 1, 0)) >= 0)
        End Function
        ...
        Public Function get_VignetEnable(ByRef bEnable As Boolean) As Boolean
            ...
            If Nncam_get_VignetEnable(_handle, iEanble) < 0 Then
                Return False
            End If
        ...
        Public Function put_VignetAmountInt(nAmount As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_VignetAmountInt(_handle, nAmount) >= 0)
        End Function
        ...
        Public Function get_VignetAmountInt(ByRef nAmount As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_VignetAmountInt(_handle, nAmount) >= 0)
        End Function
        ...
        Public Function put_VignetMidPointInt(nMidPoint As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_VignetMidPointInt(_handle, nMidPoint) >= 0)
        End Function
        ...
        Public Function get_VignetMidPointInt(ByRef nMidPoint As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_VignetMidPointInt(_handle, nMidPoint) >= 0)
        End Function
        ...
        Public Function LevelRangeAuto() As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_LevelRangeAuto(_handle) >= 0)
        End Function
        ...
        Public Function put_Option(iOption As eOPTION, iValue As Integer) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Option(_handle, iOption, iValue) >= 0)
        End Function
        ...
        Public Function get_Option(iOption As eOPTION, ByRef iValue As Integer) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Option(_handle, iOption, iValue) >= 0)
        End Function
        ...
        Public Function get_Temperature(ByRef pTemperature As Short) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Temperature(_handle, pTemperature) >= 0)
        End Function
        ...
        Public Function get_Roi(ByRef pxOffset As UInteger, ByRef pyOffset As UInteger, ByRef pxWidth As UInteger, ByRef pyHeight As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_Roi(_handle, pxOffset, pyOffset, pxWidth, pyHeight) >= 0)
        End Function
        ...
        Public Function put_Roi(xOffset As UInteger, yOffset As UInteger, xWidth As UInteger, yHeight As UInteger) As Boolean
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_put_Roi(_handle, xOffset, yOffset, xWidth, yHeight) >= 0)
        End Function
        ...
        Public Function get_FrameRate(ByRef nFrame As UInteger, ByRef nTime As UInteger, ByRef nTotalFrame As UInteger) As Boolean
            ...
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_FrameRate(_handle, nFrame, nTime, nTotalFrame) >= 0)
        End Function
        ...
        Public Function AwbInit() As Boolean
            ...
            Return (Nncam_AwbInit(_handle, IntPtr.Zero, IntPtr.Zero) >= 0)
        End Function
        ...
        Public Function FfcOnePush() As Integer
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_FfcOnePush(_handle) >= 0)
        End Function
        ...
        Public Function FfcExport(filepath As String) As Integer
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_FfcExport(_handle, filepath) >= 0)
        End Function
        ...
        Public Function DfcExport(filepath As String) As Integer
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_DfcExport(_handle, filepath) >= 0)
        End Function
        ...
        Public Function IoControl(index As UInteger, eType As eIoControType, inVal As Integer, ByRef outVal As UInteger) As Integer
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_IoControl(_handle, index, eType, inVal, outVal) >= 0)
        End Function
        ...
        Public Function get_AfParam(ByRef pAfParam As AfParam) As Integer
            If _handle Is Nothing OrElse _handle.IsInvalid OrElse _handle.IsClosed Then
                Return False
            End If
            Return (Nncam_get_AfParam(_handle, pAfParam) >= 0)
        End Function
        ...
        Public Function GetHistogram(fnHistogramProc As DelegateHistogramCallback) As Boolean
            ...
            _pHistogramCallback = New PINNCAM_HISTOGRAM_CALLBACK(AddressOf HistogramCallback)
