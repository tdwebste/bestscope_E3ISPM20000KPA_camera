...
[im, width, height, ToupcamData]=mexToupcam(nResolutionIndex, nSpeed, devList(index).id, index);
setappdata(hObject,'ToupcamData',ToupcamData);
...
set(handles.slider_temp,'Value',ToupcamData.TOUPCAM_TEMP_DEF);
set(handles.slider_tint,'Enable','on');
set(handles.slider_tint,'Value',ToupcamData.TOUPCAM_TINT_DEF);
set(handles.text_temp,'Visible','on');
set(handles.text_temp,'String',num2str(ToupcamData.TOUPCAM_TEMP_DEF));
set(handles.text_tint,'Visible','on');
set(handles.text_tint,'String',num2str(ToupcamData.TOUPCAM_TINT_DEF));
set(handles.text_hue,'Visible','on');
set(handles.text_hue,'String',num2str(ToupcamData.TOUPCAM_HUE_DEF));
set(handles.slider_hue,'Enable','on');
set(handles.slider_hue,'Value',ToupcamData.TOUPCAM_HUE_DEF);
set(handles.text_saturation,'Visible','on');
set(handles.text_saturation,'String',num2str(ToupcamData.TOUPCAM_SATURATION_DEF));
set(handles.slider_saturation,'Enable','on');
set(handles.slider_saturation,'Value',ToupcamData.TOUPCAM_SATURATION_DEF);
set(handles.text_brightness,'Visible','on');
set(handles.text_brightness,'String',num2str(ToupcamData.TOUPCAM_BRIGHTNESS_DEF));
set(handles.slider_brightness,'Enable','on');
set(handles.slider_brightness,'Value',ToupcamData.TOUPCAM_BRIGHTNESS_DEF);
set(handles.text_contrast,'Visible','on');
set(handles.text_contrast,'String',num2str(ToupcamData.TOUPCAM_CONTRAST_DEF));
set(handles.slider_contrast,'Enable','on');
set(handles.slider_contrast,'Value',ToupcamData.TOUPCAM_CONTRAST_DEF);
set(handles.text_gamma,'Visible','on');
set(handles.text_gamma,'String',num2str(ToupcamData.TOUPCAM_GAMMA_DEF));
set(handles.slider_gamma,'Enable','on');
set(handles.slider_gamma,'Value',ToupcamData.TOUPCAM_GAMMA_DEF);
...
bStop = 1;
mexToupcam(12,0);
ToupcamData = getappdata(handles.listbox_device,'ToupcamData');
set(handles.text_temp,'String', num2str(ToupcamData.TOUPCAM_TEMP_DEF));
set(handles.slider_temp,'Value', ToupcamData.TOUPCAM_TEMP_DEF);
set(handles.text_tint,'String', num2str(ToupcamData.TOUPCAM_TINT_DEF));
set(handles.slider_tint,'Value', ToupcamData.TOUPCAM_TINT_DEF);
